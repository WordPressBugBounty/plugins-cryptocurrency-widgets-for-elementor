...
if ($card_style == 'style-1') {
    ...
    if ($display_rank == 'yes') {
        $content .= '<div class="ccew-info-item">
                    <span class="ccew-item-label">' . __('Rank:', 'cryptocurrency-widgets-for-elementor') . '</span>
    ...
    if ($display_1h_changes == 'yes') {
        $content .= '<div class="ccew-info-item">
                   <span class="ccew-item-label">' . __('1H change:', 'cryptocurrency-widgets-for-elementor') . '</span>
                   <span class="ccew-item-value">' . ccew_changes_up_down($change_1h) . '</span>
                </div>';
    }
    if ($display_24h_changes == 'yes') {
        $content .= '<div class="ccew-info-item">
                    <span class="ccew-item-label">' . __('24H change:', 'cryptocurrency-widgets-for-elementor') . '</span>
                    <span class="ccew-item-value">' . ccew_changes_up_down($change_24h) . '</span>
                </div>';
    }
    if ($display_7d_changes == 'yes') {
        $content .= '<div class="ccew-info-item">
                   <span class="ccew-item-label">' . __('7d change:', 'cryptocurrency-widgets-for-elementor') . '</span>
                   <span class="ccew-item-value">' . ccew_changes_up_down($change_7d) . '</span>
                </div>';
    }
    if ($display_30d_changes == 'yes') {
        $content .= '<div class="ccew-info-item">
                    <span class="ccew-item-label">' . __('30d change:', 'cryptocurrency-widgets-for-elementor') . '</span>
                    <span class="ccew-item-value">' . ccew_changes_up_down($change_30d) . '</span>
                </div>';
    }
    if ($display_marketcap == 'yes') {
        $content .= '<div class="ccew-info-item">
                    <span class="ccew-item-label">' . __('Market Cap:', 'cryptocurrency-widgets-for-elementor') . '</span>
                    <span class="ccew-item-value">' . esc_html($market_cap) . '</span>
                </div>';
    }
    if ($display_high_low == 'yes') {
        $content .= '<div class="ccew-info-item">
                    <span class="ccew-item-label">' . __('24H High/Low', 'cryptocurrency-widgets-for-elementor') . '</span>
    ...
    if ($display_24h_changes == 'yes') {
        $content .= '<div class="ccew-card-change"><span>' . ccew_changes_up_down($change_24h) . '</span><span class="ccew-changes-time">' . esc_html__('24H', 'cryptocurrency-widgets-for-elementor') . '</span></div>';
    ...
    if ($ccew_card2_changes == "yes") {
        $content .= '<div class="ccew-card-volume"><span>' . esc_html($changes) . '</span><br><span class="ccew-changes-time">' . esc_html__('Changes 24H', 'cryptocurrency-widgets-for-elementor') . '</span></div>';
    }
    $content .= '</div>
                    </div>';
    ...
    if ($api == "coin_gecko") {
        $content .= '<div class="ccew-low-24">⇣ ' . esc_html($low_24h) . '<br><span class="ccew-changes-time">' . esc_html__('Low 24H', 'cryptocurrency-widgets-for-elementor') . '</span></div>';
        $content .= '<div class="ccew-high-24">⇡ ' . esc_html($high_24h) . '<br><span class="ccew-changes-time">' . esc_html__('High 24H', 'cryptocurrency-widgets-for-elementor') . '</span></div>';
    }
    $content .= '</div></div>';
    $content .= '</div>';
}
