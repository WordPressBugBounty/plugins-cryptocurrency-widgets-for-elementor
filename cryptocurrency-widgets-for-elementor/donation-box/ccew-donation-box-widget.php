...

{
    ...
    public function __construct($data = array(), $args = null)
    {
        ...
        wp_register_style('ccewd-donation-style', esc_url(CCEW_URL . 'donation-box/assets/css/ccew-donation-style.css'), array(), esc_attr(CCEW_VERSION));
    ...
    {
        return array('ccew-metamask', 'ccew-clipboard', 'ccew-custom', 'ccew-sweetalert2', 'ccew-etherjs', 'ccew-qr', 'ccew-custom-qr',);
      ...
      $this->add_control(
            ...
            array(
                ...
                'raw' => '<ul class="ccew-promotion-plugins">
                            ...
                            </div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="'.esc_url(CCEW_DEMO_URL.'/demo/coins-marketcap/'.CCEW_CMC_UTM).'" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a> <a class="ccew_demo_buyk" href="https://cryptocurrencyplugins.com/wordpress-plugin/coins-marketcap/?utm_source=ccew_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=cmc_widget_panel" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
                            </div>
                            <hr>
                            <div class="ccew_cmc_demo">
                            ...
                            Show cryptocurrency price table, historical charts, tickers and other widgets inside any page or post.</div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="'.esc_url(CCEW_DEMO_URL.'/demo/cryptocurrency-widgets-pro/'.CCEW_UTM).'" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a><a class="ccew_demo_buyk"  href="https://cryptocurrencyplugins.com/wordpress-plugin/cryptocurrency-widgets-pro/?utm_source=ccew_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=ccw_widget_panel" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
                            </div>
                          </ul>',
