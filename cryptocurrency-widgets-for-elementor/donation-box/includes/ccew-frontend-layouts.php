	...
	foreach ( $all_coin_wall_add as $id => $address ) {
		...
		if ( $design_type == 'list' ) {
			if ( $address['ccewd_coin_list'] !== 'metamask' && ! empty( $address['ccewd_wallet_address'] ) ) {
				...
				$classic_list             .= '<div id="qrcode-' . esc_attr( $address['ccewd_coin_list'] ) . '-classic-wallet-address-' . esc_attr( $random ) . '" class="ccewd_qr_code" data-qr-id="qrcode-' . esc_attr( $address['ccewd_coin_list'] ) . '-classic-wallet-address-' . esc_attr( $random ) . '">';
			...
			if ( $address['ccewd_coin_list'] != 'metamask' && ! empty( $address['ccewd_wallet_address'] ) ) {
				$coin_tabs .= '<div id="qrcode-' . esc_attr( $address['ccewd_coin_list'] ) . '-wallet-address-' . esc_attr( $random ) . '" class="ccewd_qr_code" data-qr-id="qrcode-' . esc_attr( $address['ccewd_coin_list'] ) . '-wallet-address-' . esc_attr( $random ) . '">';
