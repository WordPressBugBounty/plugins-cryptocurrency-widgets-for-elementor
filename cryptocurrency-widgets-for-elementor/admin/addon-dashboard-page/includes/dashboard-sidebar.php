...
?>
 ...
 <div class="cool-body-right">
    <a href="https://coolplugins.net/?utm_source=ccew_plugin&utm_medium=inside&utm_campaign=author_page&utm_content=dashboard" target="_blank"><img src="<?php echo esc_url(plugin_dir_url( $this->addon_file ) .'/assets/coolplugins-logo.png'); ?>"></a>
